    ...
    Column(
        ...
        Column(
            ...
            Image(
                ...
                painter = painterResource(id = R.drawable.image_26),
                contentDescription = ""
            )
        }
        ...
        Text(
            modifier = Modifier.padding(horizontal = 30.dp),
            text = "Fico bobinha quando vc me dar muitos beijinhos e fica sendo gay",
        ...
        Button(
            onClick = {
                navController.navigate(Graph.TEN_SCREEN)
            },
