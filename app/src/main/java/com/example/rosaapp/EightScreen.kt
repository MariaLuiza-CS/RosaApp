...
fun EightScreen(
    ...
    Column(
        ...
        Text(
            modifier = Modifier.padding(horizontal = 30.dp),
            text = "E o seu olhinho pequeno de sono e a MINHA mechinha e o MEU biquinho e os seus deliniados...",
        ...
        Button(
            onClick = {
                navController.navigate(Graph.NINE_SCREEN)
            },
