...
fun TwelveScreen(
    ...
    Column(
        ...
        Text(
            ...
            text = "Agora eu tenho uma pergunta",
        ...
        Text(
            modifier = Modifier.padding(horizontal = 30.dp),
            text = "Se por um acaso, bem acaso, eu te pedir em namoro, o que você iria falar?",
        ...
        Button(
            onClick = {
                navController.navigate(Graph.THIRTEEN_SCREEN)
            },
