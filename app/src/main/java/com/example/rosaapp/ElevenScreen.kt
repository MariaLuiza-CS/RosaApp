...
fun ElevenScreen(
    ...
    Column(
        ...
        Text(
            ...
            text = "Me sinto bem quando estou com você",
        ...
        Text(
            modifier = Modifier.padding(horizontal = 30.dp),
            text = "As vezes eu fico com um pouco de vergonha, pq as outras pessas tbm conseguem sentir tua catinga né...",
        ...
        Button(
            onClick = {
                navController.navigate(Graph.TWELVE_SCREEN)
            },
